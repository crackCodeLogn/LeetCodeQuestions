 ...
 * @since 2024-07-14
 */
public class Q0726_H_NumberOfAtoms {

    private int i = 0;

    public static void main(String[] args) {
        Q0726_H_NumberOfAtoms q726HNumberOfAtoms = new Q0726_H_NumberOfAtoms();
        System.out.println(q726HNumberOfAtoms.countOfAtoms("H20"));
        System.out.println(q726HNumberOfAtoms.countOfAtoms("Mg(OH)2"));
        System.out.println(q726HNumberOfAtoms.countOfAtoms("K4(ON(SO3)2)2"));
    }
