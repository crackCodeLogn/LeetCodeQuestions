 ...
 * @since 2024-07-13
 */
public class Q2751_H_RobotCollisions {

    public static void main(String[] args) {
        Q2751_H_RobotCollisions q2751HRobotCollisions = new Q2751_H_RobotCollisions();
        System.out.println(q2751HRobotCollisions.survivedRobotsHealths(new int[]{5, 4, 3, 2, 1}, new int[]{2, 17, 9, 15, 10}, "RRRRR"));
    }
